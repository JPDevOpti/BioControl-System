...
import { UserCircleIcon, MailIcon, UserGroupIcon, CheckIcon, ErrorIcon, DocumentIcon } from '@/assets/icons'
...
const getIconComponent = () => {
  const iconMap: Record<string, any> = {
    user: UserCircleIcon,
    email: MailIcon,
    phone: MailIcon, // Usar MailIcon como fallback para teléfono
    document: DocumentIcon,
    role: UserGroupIcon,
    status: props.statusColor === 'green' ? CheckIcon : ErrorIcon,
    initials: UserCircleIcon,
    registro: DocumentIcon
  }
  return iconMap[props.icon] || UserCircleIcon
}
