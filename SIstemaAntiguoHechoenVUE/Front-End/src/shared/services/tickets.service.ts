...
export class TicketsService {
  ...
  async uploadImage(ticketCode: string, file: File): Promise<string> {
    ...
    return (response.data as any).image_url
  }
  ...
  async getNextConsecutive(): Promise<string> {
    ...
    return (response.data as any).codigo_consecutivo
  }
  ...
  async testConnection(): Promise<boolean> {
    try {
      ...
      return (response.data as any).message === 'Tickets router funcionando correctamente'
    } catch {
      return false
    }
  }
