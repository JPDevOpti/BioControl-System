<!--
  ...
  Encabezado principal de MedInventory.
  Incluye toggle del sidebar, logo, barra de búsqueda y menú de usuario.
-->
<template>
  <header
    class="sticky top-0 flex w-full border-b border-gray-200 bg-white shadow-sm transition-colors duration-200 z-[300] lg:border-b lg:shadow-none"
  >
    <div class="flex w-full items-center justify-between px-4 py-3 lg:px-6 lg:py-4">
      ...
      <div class="flex items-center gap-3">
        <button
          @click="handleToggle"
          class="flex h-10 w-10 items-center justify-center rounded-lg text-gray-600 transition-colors duration-200 hover:bg-gray-100 lg:hidden"
...
// Manejar el toggle responsive del sidebar
const handleToggle = () => {
...
// Manejar el resize de ventana para cerrar el menú móvil
const handleResize = () => {
  if (window.innerWidth >= 1024) {
