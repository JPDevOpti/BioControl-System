...
import NewCaseIcon from "./NewCaseIcon.vue";
...
import NewEquipmentIcon from "./NewEquipmentIcon.vue";
import MoneyIcon from "./MoneyIcon.vue";
import NewFileIcon from "./NewFileIcon.vue";
import SearchEditIcon from "./SearchEditIcon.vue";
